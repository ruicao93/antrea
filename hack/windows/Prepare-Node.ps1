...
.EXAMPLE
PS> .\PrepareNode.ps1 -KubernetesVersion v1.17.0 -InstallOVS -NodeIP 192.168.1.10

#>

Param(
    [parameter(Mandatory = $false, HelpMessage="Kubernetes version to use")] [string] $KubernetesVersion="v1.17.0",
